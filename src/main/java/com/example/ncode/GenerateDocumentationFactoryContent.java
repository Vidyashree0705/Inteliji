...
public class GenerateDocumentationFactoryContent extends JPanel {
    ...
    public GenerateDocumentationFactoryContent() {
        ...
        codeScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY), "Selected Code"));
        ...
        chatScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY), "Documentation Output"));
