...
public class DisplayQuestionToolWindowContent extends JPanel {
    ...
    public DisplayQuestionToolWindowContent() {
        ...
        askQuestionField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            public void insertUpdate(javax.swing.event.DocumentEvent e) { toggleSendButton(); }
            public void removeUpdate(javax.swing.event.DocumentEvent e) { toggleSendButton(); }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { toggleSendButton(); }
        });
    ...
    private void sendMessage() {
        ...
        if (questionText.isEmpty() || askQuestionField.getText().equals("Ask NCode...")) return;
